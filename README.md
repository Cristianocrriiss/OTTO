...
<img src="src/assets/login.jpeg" alt="Projeto" width="1280px"/>

- **Tela de Principal**: chat geral e menu lateral
<img src="src/assets/chat.png" alt="Projeto" width="1280px"/>

- **Tela de Conversa**: chat de uma conversa antiga salva
<img src="src/assets/chat 2.png" alt="Projeto" width="1280px"/>

- **Tela de Correção de Redação**: função de correção de redação com IA
<img src="src/assets/redacao.png" alt="Projeto" width="1280px"/>

- **Tela de Geração de Plano de Aula**: função de geração de planos de aulas com IA
<img src="src/assets/plano de aula.jpeg" alt="Projeto" width="1280px"/>
